...
def test_resource_list(client, mce_app_resource_list, mce_app_company_user, settings):
...
def test_resource_detail(client, mce_app_resource, mce_app_company_user):

    client.force_authenticate(user=mce_app_company_user)
