    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('settings', mce_django_app.utils.JSONField(blank=True, default={}, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='account',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='mce_django_app_subscriptionazure_related', related_query_name='mce_django_app_subscriptionazures', to='mce_django_app.GenericAccount'),
        ),
        migrations.AddField(
            model_name='subscriptionazure',
            name='company',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='mce_django_app_subscriptionazure_related', related_query_name='mce_django_app_subscriptionazures', to='mce_django_app.Company'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='resource',
            name='company',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='mce_django_app.Company'),
        ),
        migrations.AddField(
            model_name='resource',
            name='resource_type',
        ...
        migrations.AddField(
            model_name='user',
            name='company',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='mce_django_app.Company', verbose_name='Société'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
