    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='company_owners', to='auth.Group')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='company',
            name='user_group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='company_users', to='auth.Group'),
        ),
        migrations.AddField(
            model_name='company',
            name='zones',
            field=models.ManyToManyField(to='mce_django_app.Zone'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('is_service', models.BooleanField(default=False, verbose_name='Service Account ?')),
                ('password', models.CharField(help_text='Notice: No password for services accounts', max_length=128, null=True, verbose_name='Password')),
                ('company', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='mce_django_app.Company', verbose_name='Company')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='mce_django_app.Region')),
                ('resource_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='mce_django_app.ResourceAzure')),
                ('subscription', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='mce_django_app.SubscriptionAzure')),
            ],
            options={
